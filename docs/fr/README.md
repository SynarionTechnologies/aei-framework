...
Étendez le réseau en envoyant une commande gérée par l’infrastructure orientée
événements :
...
Réduisez le réseau via un handler dédié :
...
src/
  ...
  domain/      # agrégats et événements de domaine
  application/ # commandes, requêtes et handlers
  infrastructure/
    event_store.rs  # implémentations de l'event store
